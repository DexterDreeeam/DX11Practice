...
bool GameSpriteDemo::LoadContent()
{
    ///VS
    ID3DBlob * vsBuffer = 0;
    bool compileResult = CompileD3DShader("shd/GameSpriteDemo.fx", "VS_Main", "vs_4_0", &vsBuffer);
    ...
    ///PS
    ID3DBlob * psBuffer = 0;
    compileResult = CompileD3DShader("shd/GameSpriteDemo.fx", "PS_Main", "ps_4_0", &psBuffer);
    if (compileResult == false)
    {
