...
void CubeDemo::Render()
{
    ...
    XMMATRIX translationMat = XMMatrixTranslation(
        0.0f,
        0.0f,
        6.0f
    );
...
bool CubeDemo::LoadContent()
{
    ...
    bool compileResult = CompileD3DShader("shd/CubeDemo.hlsl", "VS_Main", "vs_4_0", &vsBuffer);
    ...
    compileResult = CompileD3DShader("shd/CubeDemo.hlsl", "PS_Main", "ps_4_0", &psBuffer);
    ...
    d3dResult = D3DX11CreateShaderResourceViewFromFile(d3dDevice_,
        "res/CubeDemo.dds", 0, 0, &colorMap_, 0);
